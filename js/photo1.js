...
export async function sendImagesToServer() {
  try {
    ...
    const image1 = fs.readFileSync("./assests/img-py/image1-backup.jpg");
    const image2 = fs.readFileSync("./assests/img-py/image2-backup.jpg");
    const image3 = fs.readFileSync("./assests/img-py/image3-backup.jpg");
